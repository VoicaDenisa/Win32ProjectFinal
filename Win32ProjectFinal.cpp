...
int dist[N][N];
int graph[N][N] = { { 0,   INF,  20, 10, 11, INF, INF },
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hbrBackground  = CreateSolidBrush(RGB(250, 100, 110));
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE: 
	{
		...
		text1 = CreateWindow("STATIC", "Va rog sa introduceti obiectivul de plecare:", WS_VISIBLE | WS_CHILD | WS_BORDER, 80, 350, 300, 30, hWnd, NULL, NULL, NULL);

		text2 = CreateWindow("STATIC", "Va rog sa introduceti obietivul de sosire:", WS_VISIBLE | WS_CHILD | WS_BORDER, 80, 450, 300, 30, hWnd, NULL, NULL, NULL);
    ...
    case WM_COMMAND:
        {
			...
			case IDM_GATA1:
				...
				if (flag == 1)
				{
				MessageBox(hWnd, "", "Obiectiv inexistent! Introduceti un alt obiectiv!", MB_OK);
				}
				else
				{
